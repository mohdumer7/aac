...
export const baseApi = createApi({
  ...
  tagTypes: ['User', 'Post', 'Comment', 'Master', 'Application', 'Email','Ticket','TicketCategory','TicketComment','TicketHistory','TicketTask','UserSkill', 'SmlFile', 'Notification', 'ApprovalFlow', 'Department', 'UserListForFlow', 'HRMS_Dashboard', 'HRMS_Form', 'HRMS_ApprovalInstance', 'HRMS_ApprovalFlow', 'ManpowerRequisition', 'HRMS_Config'], // Define entity types for cache invalidation
